CREATE TABLE `GTS_NOTIFICATIONS_GROUP_SUBSCRIBERS` (
  `GTS_NOTIFICATION_GROUP_SUBSCRIBER_ID` BIGINT NOT NULL,
  `GTS_USER_ID` BIGINT NOT NULL,
  `GTS_NOTIFICATION_GROUP_ID` VARCHAR(50) NOT NULL,
  PRIMARY KEY(GTS_NOTIFICATION_GROUP_SUBSCRIBER_ID),
